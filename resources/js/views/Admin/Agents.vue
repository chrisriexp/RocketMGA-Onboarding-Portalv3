<template>
    ...
    <div class="sm:ml-64 p-10 h-screen bg-custom-bg">
        <div class="grid gap-2 text-custom-gray">
            <h1 class="font-semibold text-2xl">Agents Onboarding</h1>
            <p>Below is the list of agents that are still completing their onboarding application.</p>
        </div>
...
export default {
    ...
    async created(){
        ...
        await axios.get('/api/onboarding/agents')
        .then(response => {
