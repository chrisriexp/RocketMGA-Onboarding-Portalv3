<template>
    ...
    <form @submit.prevent="register" class="grid gap-4 w-fit h-fit mx-auto mt-32 px-16 py-8 bg-white shadow-newdrop border-custom-gray border-[1px] border-opacity-20 rounded-lg z-10 relative">
        ...
        <router-link to="/" class="text-sm text-custom-dark-blue text-center">Already have an account? <span class="underline">Login</span></router-link>
    </form>
